...
export default function Courses({ courses, settings }: CoursesProps) {
    ...
    const displayedCourses = showAll
        ? courses
        : courses.slice(0, INITIAL_COURSES_COUNT);

    const hasMoreCourses = courses.length > INITIAL_COURSES_COUNT;
    const remainingCount = courses.length - INITIAL_COURSES_COUNT;
